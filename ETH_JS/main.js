...
async function getPrice(factory, amtIn, tradeDirection) {
  ...
  // Get Provider
  const provider = new ethers.providers.JsonRpcProvider("https://mainnet.infura.io/v3/9a353b463f5849e0b3bb460b028f4205");
  const ABI = [
...
async function getDepth(amountIn) {
  ...
  let fileInfo = getFile("../Uniswap_V3/uniswap_surface_rates.json");
